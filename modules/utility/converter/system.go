	...
	return UnitSystem{
		...
		Units: map[string]Unit{
			...
			"Kilobits": {
				...
				ToBaseFunc:   func(val float64) float64 { return (val * 1024) / 8.0 },
				FromBaseFunc: func(val float64) float64 { return (val * 8.0) / 1024 },
			},
			"Megabits": {
				Name:         "Megabits",
				Symbol:       "Mbit",
				Aliases:      []string{"megabit", "megabits"},
				ToBaseFunc:   func(val float64) float64 { return (val * 1048576) / 8.0 },
				FromBaseFunc: func(val float64) float64 { return (val * 8.0) / 1048576 },
			},
			"Gigabits": {
				Name:         "Gigabits",
				Symbol:       "Gbit",
				Aliases:      []string{"gigabit", "gigabits"},
				ToBaseFunc:   func(val float64) float64 { return (val * 1073741824) / 8.0 },
				FromBaseFunc: func(val float64) float64 { return (val * 8.0) / 1073741824 },
			},
			"Terabits": {
				Name:         "Terabits",
				Symbol:       "Tbit",
				Aliases:      []string{"terabit", "terabits"},
				ToBaseFunc:   func(val float64) float64 { return (val * 1099511627776) / 8.0 },
				FromBaseFunc: func(val float64) float64 { return (val * 8.0) / 1099511627776 },
			},
			"Bytes": {
				Name:         "Bytes",
				Symbol:       "B",
